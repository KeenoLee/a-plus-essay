    ...
    return (
        <View>
            <View style={{marginTop: 30,marginLeft:15}}>
                <Text style={{ fontWeight: 'bold', fontSize:30, color:"#14532d"}}>Welcome</Text>
            </View>
            <View style={{ alignItems: 'center', marginTop: 20}}>
                {/* <Text style={{ fontWeight: 'bold', fontSize:20, textAlign:'left' }}>Welcome</Text> */}
                ...
                <View style={{ alignItems: 'center', marginTop: 30 }}>
                    ...
                    <TouchableOpacity>
                        <Text style={{ fontWeight: 'bold', fontSize: 12 , fontWeight: 'bold'}}> Terms and Privacy Statement</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
